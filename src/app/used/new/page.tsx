...
export default async function UsedNewPage() {
  ...
  return (
    <div className="py-4 max-w-lg mx-auto">
      <Link href="/used" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground font-medium mb-4">
        <ChevronLeft className="h-4 w-4" />
        중고거래 홈
      </Link>
      <h1 className="text-xl font-bold mb-1">내 물건 팔기</h1>
      <p className="text-sm text-muted-foreground mb-6">사진·가격·거래 지역을 입력해 글을 올려 보세요.</p>
