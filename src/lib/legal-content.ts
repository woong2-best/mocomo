...
export const TERMS_OF_SERVICE: LegalDocument = {
  ...
  blocks: [
    ...
    { type: "h3", text: "7. (경매 거래 관리 수칙)" },
    {
      type: "p",
      text: "① 경매는 이용자 간 입찰·낙찰을 연결하는 중개 기능입니다. 회사는 경매 대금을 보관·에스크로·직접 수령하지 않으며, 낙찰 후 대금 지급·물품 인도는 판매자와 낙찰자가 직접 협의·이행합니다.",
    },
    {
      type: "p",
      text: "② 입찰자는 입찰 시점에 낙찰 시 결제 의무가 발생함을 인지하고, 회사가 안내하는 결제 기한(기본 5시간, 관리자 설정에 따라 변경될 수 있음) 내에 판매자와 합의한 방식으로 대금을 지급해야 합니다.",
    },
    {
      type: "p",
      text: "③ 낙찰 후 지정된 결제 기한 내 대금 지급을 완료하지 않거나, 합리적인 사유 없이 거래를 파기하는 경우(노쇼), 의도적인 장난·허위 입찰, 입찰 취소를 반복하는 경우 회사는 다음 각 호의 조치를 취할 수 있습니다.",
    },
    {
      type: "ul",
      items: [
        "해당 경매에서의 낙찰·입찰 권리 박탈 및 차순위 입찰자에게 거래 기회 승계",
        "중고거래·경매 기능 이용 제한(경고, 일시 정지, 영구 정지 등)",
        "반복 위반 시 계정 전체 이용 제한 또는 영구 정지",
      ],
    },
    {
      type: "p",
      text: "④ 회사는 제3항에 따른 이용 제한 조치를 취하는 경우, 등록된 이메일 또는 서비스 내 알림으로 제재 사유·적용 일시·이의 신청 방법을 통지합니다.",
    },
    {
      type: "p",
      text: "⑤ 이용자는 시스템 오류, 판매자의 정당하지 않은 요청, 입찰 취소 사유 발생 등 정당한 사유가 있는 경우, 제재 통지를 받은 날로부터 7일 이내에 고객센터(support@mocomo.net) 또는 서비스 내 중고거래 이의 신청(/used/appeal)을 통해 객관적 증빙과 함께 소명(이의 신청)을 제출할 수 있습니다. 회사는 접수일로부터 합리적인 기간 내에 검토하여 타당하다고 인정되는 경우 제재를 해제하거나 변경합니다.",
    },
    {
      type: "p",
      text: "⑥ 회사는 입찰·낙찰·결제 기한·제재 적용 등 경매 거래와 관련된 기록을 분쟁·민원 대응을 위해 최소 1년간 보관할 수 있습니다.",
    },
    { type: "hr" },
    ...
    {
      type: "p",
      text: "① 회사가 제공하는 구매 MOCO, 정산 MOCO, 지갑 잔액 등 서비스 내 가상재화는 이용자가 서비스 내 특정 기능이나 콘텐츠를 이용할 수 있도록 부여된 비독점적이고 양도 불가능한 서비스 이용권(License)에 불과하며, 현금, 수신금액 또는 법화 형태의 재산권이 아닙니다.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "① 구매 MOCO는 디지털 소비성 포인트로, 결제 완료 즉시 제공되며 청약철회(환불)가 불가능합니다.",
    },
    {
      type: "p",
    ...
    },
    {
      ...
      items: [
        ...
        "구매 MOCO의 일부 또는 전부를 소비(콘텐츠 구매, 후원, 아이템 교환 등)한 경우",
...
export const CREATOR_TERMS: LegalDocument = {
  ...
  blocks: [
    ...
    { type: "hr" },
    { type: "h2", text: "제4조 (크리에이터 활동 성과 보수 — Reward)" },
    {
      type: "p",
      text: "① 크리에이터는 구독, 후원, 디지털 콘텐츠·스타 마켓 판매 등 플랫폼 활동을 통해 '정산 MOCO'(성과 스코어)를 적립할 수 있습니다. 정산 MOCO는 현금·환전·출금 수단이 아니며, 플랫폼 활동의 정량적 지표입니다.",
    },
    {
      type: "p",
      text: "② 회사는 매월 말 정산 MOCO에 정산 요율을 적용하여, 크리에이터에게 '크리에이터 활동 성과 보수(Reward)'를 현지 통화로 지급합니다. Reward 지급이 완료되면 해당 기간의 정산 MOCO는 0으로 리셋됩니다.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "④ 정산 등급별 Reward에는 MOCO 액면가($5/MOCO) 기준 플랫폼 수수료(5%)가 사전 반영되어 있습니다(크리에이터 정산 단가 $4.75/MOCO). PG(결제 대행) 실비는 구매자 충전 시 별도 표시·징수될 수 있습니다. 회사는 Reward 지급 시 소득세 등 세금을 원천징수하지 않으며, 세무 신고·납부 의무는 크리에이터 본인에게 있습니다. (미국 등 요건 충족 시 1099-NEC 등 세무 서류가 발급될 수 있습니다.)",
    },
    {
      type: "p",
...
export const CREATOR_SETTLEMENT_QNA: LegalDocument = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "월말 정산 시 건별로 계산하는 방식이 아닌, 한 달 동안 모은 earned MOCO로 달성한 'Reward 정산 등급'(Novice/Pulse 등)에 따라 확정 정산금(Reward)이 지급됩니다. 이 등급은 후원 광석(Seed/Stone 등) 등급과 별개입니다. Reward 금액에는 플랫폼 수수료(5%)가 이미 반영되어 있습니다. Stripe Connect 송금 시 Express 계정 유지비·해외 송금 수수료 등은 Stripe 정책에 따라 크리에이터 Connect 계정에서 실비 차감될 수 있습니다.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Reward 정산 등급은 후원 광석 등급과 별개입니다. 매월 모은 earned MOCO 기준으로 등급이 산정되며, 등급별 지급 금액은 아래와 같습니다. (1 MOCO = $5 액면가, 플랫폼 5% 차감 → $4.75/MOCO 반영)",
    },
    {
      type: "table",
      headers: ["Reward 정산 등급", "필요 earned MOCO", "정산금 (Reward)"],
      rows: [
        ["Novice", "0 MOCO", "$0"],
        ["Pulse", "10 MOCO", "$47.50"],
        ["Nexus", "15 MOCO", "$71.25"],
        ["Matrix", "30 MOCO", "$142.50"],
        ["Flux", "50 MOCO", "$237.50"],
        ["Vortex", "60 MOCO", "$285"],
        ["Horizon", "70 MOCO", "$332.50"],
        ["Genesis", "90 MOCO", "$427.50"],
        ["Continuum", "120 MOCO", "$570"],
        ["Singularity", "160 MOCO", "$760"],
        ["Zenith", "200 MOCO", "$950"],
        ["Eclipse", "260 MOCO", "$1,235"],
        ["Aether", "350 MOCO", "$1,662.50"],
        ["Eternity", "500 MOCO", "$2,375"],
        ["Transcend", "700 MOCO", "$3,325"],
        ["Infinity", "1,000 MOCO", "$4,750"],
        ["Cosmos", "1,500 MOCO", "$7,125"],
        ["Dimension", "2,200 MOCO", "$10,450"],
        ["Chronos", "3,200 MOCO", "$15,200"],
        ["Omniverse", "4,500 MOCO", "$21,375"],
        ["Absolute", "6,500 MOCO", "$30,875"],
        ["Primeval", "9,000 MOCO", "$42,750"],
        ["Firmament", "13,000 MOCO", "$61,750"],
        ["Aethelgard", "18,000 MOCO", "$85,500"],
        ["Supernova", "25,000 MOCO", "$118,750"],
        ["Empyrean", "35,000 MOCO", "$166,250"],
        ["Aethelos", "48,000 MOCO", "$228,000"],
        ["Sovereign", "65,000 MOCO", "$308,750"],
        ["Origin", "82,000 MOCO", "$389,500"],
        ["Supreme", "100,000 MOCO", "$475,000"],
      ],
    },
    { type: "hr" },
