...
export const MobileApi = {
  auth: {
    ...
    oauthCompleteSignup: "/api/mobile/auth/oauth/complete-signup",
    google: "/api/mobile/auth/google",
    googleConfig: "/api/mobile/auth/google/config",
    naver: "/api/mobile/auth/naver",
    line: "/api/mobile/auth/line",
    signupCheck: "/api/mobile/auth/signup/check",
    signupRegister: "/api/mobile/auth/signup/register",
    signupVerify: "/api/mobile/auth/signup/verify",
    emailCodeSend: "/api/mobile/auth/email-code/send",
  ...
  userBlock: "/api/mobile/users/block",
  ...
  followRequests: "/api/mobile/follow/requests",
  ...
  userConnections: (username: string) =>
    `/api/mobile/users/${encodeURIComponent(username)}/connections`,
  ...
  marketplaceTradeComplete: (id: string) => `/api/mobile/marketplace/${id}/trade-complete`,
  marketplaceBump: (id: string) => `/api/mobile/marketplace/${id}/bump`,
  marketplaceMeetPins: "/api/mobile/marketplace/meet-pins",
  marketplaceTradeRequest: (id: string) => `/api/mobile/marketplace/${id}/trade-request`,
  marketplaceTradeRequestDetail: (requestId: string) =>
    `/api/mobile/marketplace/trade-requests/${requestId}`,
  marketplaceTradeRequestRespond: (requestId: string) =>
    `/api/mobile/marketplace/trade-requests/${requestId}/respond`,
  marketplaceAuctionDeposit: "/api/mobile/marketplace/auction-deposit",
  ...
  communityFeed: "/api/mobile/community/feed",
  ...
  gems: "/api/mobile/gems",
  letterDonations: "/api/mobile/letter-donations",
  tip: (id: string) => `/api/mobile/tips/${id}`,
  tipOpen: (id: string) => `/api/mobile/tips/${id}/open`,
  subscriptions: "/api/mobile/subscriptions",
