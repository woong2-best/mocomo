...
export const COMMENT_DONATION_TIERS: CommentDonationTier[] = [
  { id: "blue", minCents: 100, headerBg: "#1565C0", bodyBg: "#E3F2FD", textColor: "#0D47A1" },
  { id: "cyan", minCents: 200, headerBg: "#00838F", bodyBg: "#E0F7FA", textColor: "#006064" },
  { id: "green", minCents: 500, headerBg: "#2E7D32", bodyBg: "#E8F5E9", textColor: "#1B5E20" },
  { id: "yellow", minCents: 1000, headerBg: "#F9A825", bodyBg: "#FFF8E1", textColor: "#F57F17" },
  { id: "orange", minCents: 2000, headerBg: "#EF6C00", bodyBg: "#FFF3E0", textColor: "#E65100" },
  { id: "magenta", minCents: 5000, headerBg: "#AD1457", bodyBg: "#FCE4EC", textColor: "#880E4F" },
];
